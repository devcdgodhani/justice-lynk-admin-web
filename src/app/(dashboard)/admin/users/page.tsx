            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
                <div className="space-y-2">
                    <div className="flex items-center gap-2 text-xs font-bold text-primary uppercase tracking-[0.3em]">
                        <UsersIcon className="h-4 w-4" /> Identity Governance
                    </div>
                        ...
                        <table className="w-full">
                            <thead>
                                <tr className="border-b border-border/40 bg-muted/30">
                                    ...
                                    <th className="text-left px-6 py-5 text-[9px] font-bold text-muted-foreground uppercase tracking-[0.2em]">Role</th>
                                    <th className="text-left px-6 py-5 text-[9px] font-bold text-muted-foreground uppercase tracking-[0.2em]">Status</th>
                                    <th className="text-left px-6 py-5 text-[9px] font-bold text-muted-foreground uppercase tracking-[0.2em]">Joined</th>
                                    <th className="text-right px-10 py-5 text-[9px] font-bold text-muted-foreground uppercase tracking-[0.2em]">Actions</th>
                                </tr>
                            </thead>
                                    ...
                                    <tr key={user.id} className="hover:bg-muted/50 group transition-all duration-300">
                                        ...
                                        <td className="px-6 py-6">
                                            <Badge variant="outline" className={cn(
                                                ...
                                                user.role === 'super_admin' ? "border-primary/50 text-primary bg-primary/5" : "border-border/60 text-muted-foreground bg-card/40"
                                            )}>
                                                {user.role}
                                            </Badge>
                                        </td>
                                        ...
                                        <td className="px-6 py-6 font-mono text-[10px] font-medium text-muted-foreground/60 tracking-tighter">
